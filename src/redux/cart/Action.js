...
export const addItemToCart = (reqData)  => async(dispatch)=>{
    ...
    try {
        ...
        console.log(error)
        console.log(error.response.data.message)
        dispatch({type:ADD_ITEM_TO_CART_FAIL,payload : error.response && error.response.data.message})
...
export const updateCartItem = (reqData) => async(dispatch)=>{
    ...
    try {
        ...
        console.log(error)
        console.log(error.response.data.message)
        dispatch({type:UPDATE_CART_ITEM_FAIL,payload :  error.response.data.message})
