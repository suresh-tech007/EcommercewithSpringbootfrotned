...
const  handleAddCart=()=>{
  const data = {
    productId : params.productId,size:selectedSize.name
  }
  console.log(data)
  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-1 gap-y-10 pt-10 '>
          ...
          <div className=" flex flex-col items-center  ">
            ...
            <div className="flex flex-wrap space-x-5 justify-center">
              {product && Product.images.map((images) => (
                <div className="aspect-h-2   max-w-[5rem] max-h-[5rem] mt-4 ">
                  <img
                    alt={images.alt}
                    src={images.src}
          ...
          <div className="lg:col-span-1  mx-auto  max-w-2xl  px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24 ">
            <div className="lg:col-span-2  ">
              ...
              <h1 className="text-lg lg:text-xl  pt-1 opacity-60 text-gray-900">{product && product.title}</h1>
            </div>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className='flex items-center space-x-3 '>
                  ...
                  <p className='ml-3 text-sm hover:text-indigo-500 font-medium text-indigo-600'> Reviews </p>
                </div>
...
type='submit'
                  variant="contained" sx={{ px: "2rem", py: "1rem", mt: "1rem", bgcolor: "#9155fd" }}
                >
                  ADD TO CART
            ...
            <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
              ...
              <div className="mt-10">
                ...
                <div className="mt-4 space-y-6">
                  <p className="text-sm text-gray-600">{product && product.details}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* this for ratings and reviews  */}
        <section>
          <h1 className='font-semibold text-lg pb-4'>Recemt Review  & Rating</h1>
          <div className='border p-5'>
            <Grid container spacing={7} className=''>
              <Grid item xs={7}>

                <div className=' space-y-6'>
                  {[1, 1, , 1, 1, 1, 1].map((item, i) => <ProductReviewCard key={i} />)}
                </div>
              </Grid>
              <Grid item xs={5} >
                ...
                <div className='flex items-center space-x-3'>
                  ...
                  <p className='opacity-60'>786875 Ratings</p>
                </div>
                <Box className="mt-5 space-y-3">
                  ...
                  <Grid container justifyContent="center" alignItems="center" gap={2}>
                    ...
                    <Grid item xs={7}>
                      <LinearProgress sx={{ bgcolor: '#d0d0d0', borderRadius: 4, height: 7 }} variant='determinate' value={50} color='warning' />
                    </Grid>
        ...
        <section>
          ...
          <div className='flex flex-wrap   items-center justify-center      '>
            {mens_kurta.map((item,i)=><HomeSectionCard key={i}  item={item}/>)}
          </div>
        </section>
